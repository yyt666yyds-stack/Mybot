...
class VisionToolConfig(Base):
    """Vision tool configuration for automatic image description."""

    enabled: bool = True
    auto_describe: bool = True
    model: str = "qwen3.5-omni-plus-2026-03-15"
    provider: str = "dashscope"
    max_images_per_turn: int = Field(default=8, ge=0, le=32)
    max_description_chars: int = Field(default=1000, ge=100, le=8000)
